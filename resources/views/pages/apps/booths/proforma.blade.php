<div class="alert alert-dismissible bg-primary d-flex flex-column flex-sm-row p-5 mb-10">
    ...
    <div class="d-flex flex-column text-light pe-0 pe-sm-10">
        <!--begin::Title-->
        <h4 class="mb-2 light">Order # {{$order->reference}} has been placed successfully</h4>
        <!--end::Title-->

        <!--begin::Content-->
        <span>A proforma invoice has been sent to your email and to Kenia Accounts Office. You will be contacted shortly to proceed with payments.</span>
        <!--end::Content-->
    </div>
    <!--end::Wrapper-->
