        ...
        <div class="card-body py-4">
            <!--begin::Table-->
             <div class="newsletter-wrap">
                <form class="form w-100" action="{{ route('summits.events.update', ['event' => $event->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row mb-6">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" name="title"  autocomplete="off"
                                       value="{{ $event->title }}" class="form-control   @error('title') border-danger @enderror"/>
                                <label for="title">
                                    Summit name
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" name="lead_organization" id="lead_organization" autocomplete="off"
                                       value="{{ $event->lead_organization }}" class="form-control   @error('lead_organization') border-danger @enderror"/>
                        ...
                        <div class="col-md-10">
                            <div class="form-floating mb-3">
                                <input type="text" name="longtitle" autocomplete="off"
                                       value="{{ $event->longtitle ?? old('longtitle') }}"
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="image-input image-input-outline image-input-placeholder image-input-empty" data-kt-image-input="true">
                                <!--begin::Preview existing avatar-->
                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ storage_path('speakers/'.$event->profile_photo_url) }}');"></div>
                            ...
                            <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="text" name="leader" id="leader" value="{{ $event->leader }}"
                                       autocomplete="off" class="form-control  @error('leader') border-danger @enderror "/>
                                <label for="leader">
                                    Summit leader name
                                    <span class="required"></span>
                                </label>
                        ...
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="tel" name="leader_contact" id="leader_contact" value="{{ $event->leader_contact }}"
                                       autocomplete="off" class="form-input @error('leader_contact') border-danger @enderror"/>
                    ...
                    <div class="form-floating mb-7">
                        ...
                        value="{{ $event->targets ?? old('targets') }}" />
                        <label for="targets">
