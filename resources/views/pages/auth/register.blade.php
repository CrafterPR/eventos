<x-register-layout>
    <main class="relative">
        ...
        <div class="relative h-[60vh] sm:h-[70vh] md:h-[75vh] min-h-[450px] w-full section-visible" id="home" style="opacity: 1;">
            <!-- background color -->
            <div class="absolute inset-0 bg-cover bg-center" style="background-image:url('https://ik.imagekit.io/nkmvdjnna/PAAN/summit/purchase-ticket-hero.webp');filter:brightness(0.5)"></div>
            <!-- background color -->

            <!-- black color -->
            <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent" style="opacity: 1;"></div>
            <!-- black color -->
            ...
            <div class="relative h-full flex items-end pb-4 sm:pb-6 md:pb-8 lg:pb-10">
                <div class="mx-auto max-w-6xl w-full px-3 sm:px-4">
                    <div class="max-w-2xl" style="opacity: 1; transform: none;">
                        ...
                        <p class="text-xs sm:text-sm md:text-base font-semibold text-red-500 mb-2 sm:mb-3 md:mb-4 leading-tight">
                        ...
                        <div class="text-xs sm:text-sm md:text-base font-normal text-white mb-4 sm:mb-6 leading-tight" style="opacity: 1; transform: none;">
                            ...
                            <div class="flex flex-wrap gap-2 sm:gap-4">
                                <div class="bg-slate-800 px-3 py-2 rounded-lg text-center min-w-[60px] backdrop-blur-sm" style="opacity: 1; transform: none;">
                                    <div class="text-lg sm:text-xl font-bold">11</div>
                                    <div class="text-xs">days</div>
                                </div>
                                <div class="bg-slate-800 px-3 py-2 rounded-lg text-center min-w-[60px] backdrop-blur-sm" style="opacity: 1; transform: none;">
                                    <div class="text-lg sm:text-xl font-bold">4</div>
                                    <div class="text-xs">hours</div>
                                </div>
                                <div class="bg-slate-800 px-3 py-2 rounded-lg text-center min-w-[60px] backdrop-blur-sm" style="opacity: 1; transform: none;">
                                    <div class="text-lg sm:text-xl font-bold">58</div>
                                    <div class="text-xs">mins</div>
                                </div>
                                <div class="bg-slate-800 px-3 py-2 rounded-lg text-center min-w-[60px] backdrop-blur-sm" style="opacity: 1; transform: none;">
                                    <div class="text-lg sm:text-xl font-bold">35</div>
            ...
            <div x-data="wizard()">
                ...
                <div class="w-full py-4 sm:py-6 px-3 sm:px-4">
                    ...
                    <nav aria-label="Progress" class="max-w-3xl mx-auto">
                        <ol role="list" class="flex items-center justify-between w-full">
                            ...
                            <li :class="index < steps.length - 1 ? 'relative pr-8 sm:pr-20' : 'relative'">
                                <!-- Line between steps -->
                                <div
                                    class="absolute inset-0 flex items-center -top-[37px]"
                                    aria-hidden="true"
                                    :class="{
                                        'right-4': index === steps.length - 1,
                                        'left-2': index === 0
                                    }"
                                    >
                                </div>
                                ...
                                <div class="flex flex-col items-center">
                                    <a
                                        href="#"
                                        class="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-xs sm:text-sm font-semibold border-2"
                                        :class="{
                                            'bg-slate-800 border-slate-800 text-white': index < currentStep,
                                            'border-slate-800 text-white bg-slate-800': index === currentStep,
                                            'border-gray-300 text-gray-500 bg-white': index > currentStep
                                        }"
                                        :aria-current="index === currentStep ? 'step' : undefined"
                                        >
                                         <span class="" x-text="index+1"></span>

                                        <span class="sr-only" x-text="step"></span>
                                    </a>

                                    <!-- Step Name Styling -->
                                    <span class="mt-1 sm:mt-2 text-xs font-medium text-center max-w-[70px] sm:max-w-none" :class="{
                                        'text-slate-800': index === currentStep,       // Active step
                                        'text-slate-800': index < currentStep,               // Completed step
                                        'text-gray-500': index > currentStep                // Upcoming step
                                    }" x-text="step"></span>
                                </div>
                            </li>
                        </template>
                ...
                <main id="wizardForm" @submit.prevent="submitForm">
                    ...
                    <div>
                        <section x-cloak x-show="currentStep === 0" id="contact-info-step">
                            <div class="mx-auto max-w-7xl ">
                                <div class="text-slate-800 text-center py-4">
                                    ...
                                    <p class="font-normal">Let's start with your basic information to secure your registration.</p>
                                </div>
                        ...
                        <section x-cloak x-show="currentStep === 1">
                            <div class="mx-auto max-w-7xl ">
                                <div class="text-slate-800 text-center py-4">
                                ...
                                <div class="max-w-7xl mx-auto px-3 sm:px-4 pb-24" style="opacity: 1; transform: none;">
                                    ...
                                    <div x-data="{ tabs: [
                                        ...
                                        <div class="lg:hidden mb-4">
                                            ...
                                            <select id="tabs" name="tabs" x-model="mobileActiveTab" @change="tabs.forEach(tab => tab.active = false)" class="block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-bossanova-600 focus:outline-none focus:ring-bossanova-600 sm:text-sm">
                                    ...
                                    <div x-show="hasSelectedTickets()" x-cloak class="fixed bottom-0 left-0 right-0 bg-white border-t-2 border-[#84C1D9] shadow-2xl z-50" style="opacity: 1; transform: none;">
                                        <div class="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
                                            <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                                                ...
                                                <div class="flex items-center gap-3 w-full sm:w-auto">
                                                    <button @click="prevStep" :disabled="currentStep === 0" class="flex-1 sm:flex-none bg-gray-200 text-gray-700 px-4 sm:px-6 py-2.5 sm:py-3 rounded-full font-medium hover:bg-gray-300 transition-colors text-sm sm:text-base">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="w-4 h-4 inline mr-1 iconify iconify--mdi" width="1em" height="1em" viewBox="0 0 24 24">
                    ...
                    <!--
                        ...
                        <button @click="prevStep" :disabled="currentStep === 0" class="inline-flex justify-center rounded-lg border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-900 shadow-sm hover:bg-gray-50 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2">
                            Back
                        </button>

                        <button x-show="currentStep < steps.length - 1" @click="nextStep" class="inline-flex justify-center rounded-lg border border-mbrs-green-800 bg-mbrs-green-800 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-mbrs-green-900 focus:outline-none focus:ring-2 focus:ring-mbrs-green-700 focus:ring-offset-2">
                            Next
                        </button>

                        <button x-cloak x-show="currentStep === steps.length - 1" @click="submitForm" class="inline-flex justify-center rounded-lg border border-mbrs-green-800 bg-mbrs-green-900 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-mbrs-green-950 focus:outline-none focus:ring-2 focus:ring-mbrs-green-700 focus:ring-offset-2">
                            Complete
                        </button>
                    </div>
            ...
            <section class="relative mx-auto max-w-6xl px-3 sm:px-4 md:px-6 h-full flex items-center justify-center">
                <div class="text-left w-full max-w-4xl">
                    <div class="mb-6 sm:mb-8 md:mb-12">
                        <h3 class="text-xl sm:text-2xl md:text-3xl text-white font-bold uppercase mb-3 sm:mb-4 md:mb-6">Need Assistance?</h3>
                        <p class="text-base sm:text-lg md:text-xl font-normal text-white">Our logistics team can help with visas, hotels, and transport.</p>
                    </div>
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-8 justify-left">
                        <button class="bg-[#84C1D9] text-slate-800 px-4 sm:px-6 md:px-8 py-2 sm:py-3 rounded-full hover:bg-[#84C1D9]/90 transition-all duration-300 font-medium text-xs sm:text-sm md:text-base shadow-lg flex items-center justify-center gap-2">Talk to Us</button>
                        <button class="bg-transparent border border-white text-white px-4 sm:px-6 md:px-8 py-2 sm:py-3 rounded-full hover:bg-[#84C1D9]/90 transition-all duration-300 font-medium text-xs sm:text-sm md:text-base shadow-lg flex items-center justify-center gap-2">Visa Quick Check</button>
                    </div>
                </div>
            </section>
        </div>
        ...
        <div class="bg-slate-800 relative">
            <div class="w-full h-[20px] sm:h-[30px] md:h-[40px] relative"><img alt="" loading="lazy" decoding="async" data-nimg="fill" class="object-cover w-full h-full" style="position:absolute;height:100%;width:100%;left:0;top:0;right:0;bottom:0;color:transparent" src="https://ik.imagekit.io/nkmvdjnna/PAAN/summit/summit-pattern.svg"></div>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <ul class="space-y-2">
                                ...
                                <li><a href="/pricing" class="text-white/80 hover:text-red-500 transition-colors">Membership</a></li>
                                <li><a href="/paan-awards" class="text-white/80 hover:text-red-500 transition-colors">PAAN Awards</a></li>
                                <li><a href="https://membership.paan.africa/" class="text-white/80 hover:text-red-500 transition-colors">Join PAAN</a></li>
