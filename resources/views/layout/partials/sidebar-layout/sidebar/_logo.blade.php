...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="{{ route('dashboard') }}">
		<img alt="Logo" src="{{ image('images/logo.webp') }}" class="app-sidebar-logo-default h-65px w-225px" />
		<img alt="Logo" src="{{ image('images/logo-icon.webp') }}" class="h-50px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
