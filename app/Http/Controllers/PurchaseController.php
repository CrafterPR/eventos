...
class PurchaseController extends Controller
{
    public function store(Request $request)
    {
        ...
        try {
            ...
            // If not an authenticated user, do NOT create accounts yet.
            // Only update existing users; otherwise leave user null and defer creation until payment succeeds.
            if (!$isAuthenticatedPurchase) {
                ...
                if ($existingUser) {
                    ...
                    // Do not create a new user now; wait for payment confirmation to create an account.
                    $user = null;
                    $password = null;
                }
            } else {
            ...
            $successMessage = $isAuthenticatedPurchase
                ...
                : 'Purchase initiated. Complete payment to create your account and access your tickets.';
